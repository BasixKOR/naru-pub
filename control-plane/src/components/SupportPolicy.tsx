...
// 때는 실제 동작(정기 결제 취소는 기간 만료까지 유지, 환불은 유료 기능을
// 즉시 종료)과 어긋나지 않게 해야 한다. 7일이라는 기간은 lib/refunds의
      ...
      <CardContent className="p-6 space-y-6 text-sm">
        <section className="space-y-2">
          ...
          <p className="text-muted-foreground">
            표시된 금액이 실제 결제 금액입니다. 유료 이용자는 커스텀 도메인,
            데이터베이스, 방문자 현황, GitHub 배포 기능을 이용할 수 있습니다.
            나루의 기본 웹사이트 호스팅은 결제 여부와 관계없이 무료입니다.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <ul className="list-disc space-y-1 pl-5 text-muted-foreground">
            <li>정기 결제 (월간): 결제일로부터 1개월</li>
            <li>정기 결제 (연간): 결제일로부터 1년</li>
            <li>
              일회성 결제: 결제일로부터 {MAX_PURCHASABLE_ONE_TIME_YEARS}년
            </li>
          </ul>
          <p className="text-muted-foreground">
            유료 기능은 결제가 완료된 직후 바로 사용할 수 있으며, 한 번의
        ...
        <section className="space-y-2">
          ...
          <ul className="list-disc space-y-1 pl-5 text-muted-foreground">
            <li>
              결제일로부터 {REFUND_WINDOW_DAYS}일 이내에는 이유를 묻지 않고 전액
              환불해 드립니다. 유료 기능을 이미 쓰셨더라도 괜찮습니다.
              결제 내역에서 직접 신청하시면 바로 처리되며, 사유를 적으실 필요도
              없습니다.
            </li>
            <li>
              환불이 완료되면 해당 결제로 제공된 유료 기능은 즉시
              종료되며, 커스텀 도메인·데이터베이스·방문자 현황·GitHub 배포를 더
              이상 이용할 수 없습니다. 무료로 제공되는 웹사이트 호스팅은 그대로
              유지됩니다.
            </li>
            <li>
              정기 결제는 언제든지 취소할 수 있습니다. 취소하시면 다음 결제부터
              청구되지 않고, 이미 결제하신 기간은 만료일까지 그대로 이용하실 수
              있습니다. 이미 시작된 기간에 대한 일할 환불은 제공하지 않습니다.
              환불이 이루어지면 정기 결제도 함께 취소되어 더 이상 결제되지
              않습니다.
            </li>
            <li>
              나루의 장애나 서비스 중단으로 유료 기능을 이용하지 못한
        ...
        <section className="space-y-2">
          ...
          <p className="text-muted-foreground">
            ...
            {REFUND_WINDOW_DAYS}일이 지나지 않았다면 묻는 것 없이 그 자리에서
            처리됩니다. 환불 대금은 결제하신 카드로 취소되며, 카드사에 따라
            영업일 기준 3~5일이 더 걸릴 수 있습니다.
          </p>
          <p className="text-muted-foreground">
            {REFUND_WINDOW_DAYS}일이 지난 뒤의 환불이나, 나루의 장애로 이용하지
            못하신 경우, 그 밖의 문의는{" "}
            <a
