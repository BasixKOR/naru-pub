...
3. Nothing else needs configuring: the site name and the callback page identify the registration. Each callback keeps independent collection permissions. If the page is not registered, Naru's consent page says so and links to the control panel.
