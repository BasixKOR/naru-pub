...
- 글쓰기 → 나루로 로그인 → 승인 후 제목, 본문, 분류(선택)를 입력하세요.
- '비공개 초안 저장'은 drafts에 저장합니다. 방문자에게 보이지 않습니다.
- '글 공개하기'는 posts에 저장하고 초안을 지웁니다. 한 트랜잭션이라 둘 다 되거나 둘 다 안 됩니다.
- '목록 불러오기'에서 글이나 초안을 골라 고치거나 지우세요.
- 방명록 관리는 제어판에서 합니다.
